...
const PixelBlast = ({
  ...
  useEffect(() => {
    ...
    const uniforms = {
      ...
      uPixelSize: { value: pixelSizeRef.current * renderer.getPixelRatio() },
    ...
    threeRef.current = {
      ...
      resizeObserver: ro, raf, quad, timeOffset, composer, touch,
      liquidEffect, onPointerDown, onPointerMove
    };
  ...
  useEffect(() => {
    ...
    pixelSize, patternScale, patternDensity, enableRipples,
    rippleIntensityScale, rippleThickness, rippleSpeed, pixelSizeJitter,
